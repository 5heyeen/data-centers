...
5. **Define the operator input format** — Create `projects/operators/_template/operator.md` specifying what the user provides per operator: company name, website URL, known context/notes, market segment hint, meeting date. Done when the minimal input needed to start research is clear.
